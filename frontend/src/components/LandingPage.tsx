  ...
  const features = [
    {
      ...
      description:
        "Generate tailored resumes for each application using advanced AI technology.",
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Application Tracking",
      description:
        "Organize and track all your job applications in one intuitive kanban board.",
    },
    {
      icon: <Calendar className="w-6 h-6" />,
      title: "Interview Manager",
      description:
        "Never miss an interview with our scheduling and preparation tools.",
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Success Analytics",
      description:
        "Data-driven insights to optimize your job search strategy.",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Quick Apply",
      description:
        "Apply to multiple positions faster with saved templates and autofill.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <img src="/assets/branding/joblander-logo.jpg" alt="JobLander Logo" className="h-8" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Powerful tools designed to streamline your job
              search and maximize your success rate.
            </p>
          </div>
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-gray-900 dark:text-white text-4xl">
                      {tier.price}
                    </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              ...
              landed their dream jobs with JobLander.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              <img src="/assets/branding/joblander-logo-white.jpg" alt="JobLander Logo" className="h-6" />
            </div>
