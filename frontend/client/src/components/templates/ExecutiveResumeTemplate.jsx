      ...
      <main className="executive-body">
        <section className="executive-section">
          ...
          {experience && experience.length > 0 ? (
            experience.map((exp, index) => <div key={index} className="executive-item">{exp}</div>)
          ) : (
        ...
        <section className="executive-section">
          ...
          {education && education.length > 0 ? (
            education.map((edu, index) => <div key={index} className="executive-item">{edu}</div>)
          ) : (
